...
import { encodeBoolField, encodeStringField, encodeUInt32Field } from "./protocol.js";
...
test("activity response decoder preserves disabled and duplicate/processing contracts", () => {
  const detail = decodeByMessageType(
    ...
    Buffer.concat([encodeBoolField(1, false), encodeStringField(2, "ACTIVITY_ENGINE_UNAVAILABLE")])
  );
