...
pub fn is_low_cardinality_key(key: &str) -> bool {
    matches!(
        ...
        "virtual_players"
            ...
            | "push_out_of_order"
            | "auth_requests"
            | "auth_guard_probe_attempts"
            | "auth_guard_probe_successes"
            ...
            | "side_auth_descriptor_resolutions"
            | "side_auth_descriptor_changes"
            | "registry_read_observations"
            | "registry_instances_observed"
            | "registry_instance_metrics_observed"
            | "registry_observation_complete"
            | "registry_observation_holes"
            | "registry_heartbeat_stale"
            | "registry_discovery_late"
            | "registry_stale_cleanup_pending"
            | "registry_route_unconverged"
            | "registry_instance_metrics_missing"
            | "registry_instance_metrics_stale"
            | "registry_clock_skew_detected"
            | "registry_dependency_metrics_missing"
            | "registry_dependency_metrics_stale"
            | "registry_host_metrics_missing"
            | "registry_host_metrics_stale"
            | "registry_instance_observation_missing"
