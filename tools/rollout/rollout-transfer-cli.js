...
Options:
  ...
  --old-admin-endpoint-name <name>        default: admin (target game-server.admin)
  ...
  --new-admin-endpoint-name <name>        default: admin (target game-server.admin)
  ...
  --proxy-admin-endpoint-name <name>      default: admin (target game-proxy.admin)
