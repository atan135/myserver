...
class MemoryStore {
  constructor({ online = true } = {}) {
    ...
    this.agents = [{
      ...
      capabilities: online ? { profiles: ["codex_exec"], dryRun: false, dangerFullAccess: false } : null,
  ...
  async claimTaskDispatched(value) {
    ...
    Object.assign(current, {
      ...
      dangerFullAccess: value.dangerFullAccess,
...
class FakeGateway {
  constructor(store, clock) {
    ...
    this.connection = {
      ...
      capabilities: { dryRun: false, dangerFullAccess: false, fangyuanBlueprint: true },
      effectiveLimits: {
