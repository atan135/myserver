...
const SENSITIVE_FIELD_PATTERN = /(authorization|ticket|token|secret|password|content|body|attachments?|payload)/i;
const SENSITIVE_TEXT_PATTERN = /(?:GAME_ADMIN_TOKEN|MAIL_(?:SERVICE|OPERATIONS|HIGH_RISK)_TOKEN|\b(?:authorization|ticket|token|secret|password|content|body|attachments?|payload)\b)/i;
